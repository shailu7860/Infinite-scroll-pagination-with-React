  ...
  return (
    ...
    <div className="App">
      ...
      <div className='summary'>
        ...
        <div className='about-card' style={{ width: "100%",display:'flex',justifyContent: "space-around",
  position: "absolute",
  top: "85rem",
  
  }}>

           <MediaCard image={Image1} tilte={"Designer"} desc={"I value simple content structure, clean design patterns, and thoughtful interactions."} type={"Things I enjoy designing:"} type2={"UX, UI, Web, Mobile, Apps, Logos"} tools={" Design Tools:"} tools2={" Balsamiq Mockups Figma Invision MarvelPen & Paper Sketch Webflow Zeplin "} />
